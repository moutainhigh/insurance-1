      ...
      <div>
        ...
        <Card title="金融方案" style={{marginBottom: 24}} bordered={true}>
          <Row style={rowLayout}>
            ...
            <Col span="4"><span>{fssLoanModel.planName}</span>
            </Col>
            <Col span="2"><span>贷款期限:</span></Col>
            <Col span="4"><span>{fssLoanModel.planPeriod}</span>
            </Col>
            {/*<Col span="2"><span>利率:</span></Col>*/}
            {/*<Col span="4"><span>{fssLoanModel.loanRate}</span>*/}
            {/*</Col>*/}
            {/*<Col span="2"><span>服务费:</span></Col>*/}
            {/*<Col span="4"><span>{fssLoanModel.loanFee}</span>*/}
            {/*</Col>*/}
          </Row>
          <Row style={rowLayout}>
        ...
        <Card title="经销商信息" style={{marginBottom: 24}} bordered={true}>
          <Row style={rowLayout}>
            <Col span="2"><span>经销商名称:</span></Col>
            <Col span="6"><span>{fssLoanModel.dealerName}</span>
            </Col>
            <Col span="2"><span>提报人:</span></Col>
            <Col span="6"><span>{fssLoanModel.submitPerson} {fssLoanModel.dealerUserName}</span>
            </Col>
            <Col span="2">
            </Col>
          </Row>
