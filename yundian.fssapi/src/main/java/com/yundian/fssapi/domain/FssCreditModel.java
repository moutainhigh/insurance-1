...
public class FssCreditModel implements Serializable {
    /**
	 * 
	 */
     ...
     * 
     */
    private List<FssCreditLogModel> fssCreditLogList;
    /**
     * 获取
     *
     ...
     * @cgw 2016-10-09 10:41:49
     */
    public Date getCreditApplyTime() {
     ...
     * 设置征信申请时间
     *
     * @param creditApplyTime the value for fss_credit.credit_apply_time
     *
     * @cgw 2016-10-09 10:41:49
     */
    public void setCreditApplyTime(Date creditApplyTime) {
	...
	/**
	 * @return the fssCreditLogList
	 */
	public List<FssCreditLogModel> getFssCreditLogList() {
		return fssCreditLogList;
	}

	/**
	 * @param fssCreditLogList the fssCreditLogList to set
	 */
	public void setFssCreditLogList(List<FssCreditLogModel> fssCreditLogList) {
		this.fssCreditLogList = fssCreditLogList;
	}
