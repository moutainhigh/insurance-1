...
public class FssLoanAuditingLogModel implements Serializable {
	...
	public String toString() {
		return "FssLoanAuditingLogModel [logId=" + logId + ", loanId=" + loanId
				+ ", node=" + node + ", nodeName=" + nodeName
				+ ", organizationId=" + organizationId + ", guaranteeId="
				+ guaranteeId + ", orguserId=" + orguserId + ", orguserName="
				+ orguserName + ", auditStatus=" + auditStatus + ", auditTime="
				+ auditTime + ", auditContent=" + auditContent + ", ctime="
