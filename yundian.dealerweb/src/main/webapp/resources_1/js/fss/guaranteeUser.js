$(function () {
	$("#guaranteeUserList2_menu").addClass("active");
	$("#guaranteeUserList2_menu").parents('li').addClass("active open");
		  ...
		  "bAutoWidth":false,
		     ...
		     "columnDefs": [
				...
				},
				{
					...
					"data" : "roleId", 
					"render" : function(data, type, full) {
						return handle_roleId(data, full, 1);
					}
				},
				{
				"targets" : [ 5,11], // 目标列位置，下标从0开始
					"render" : function(data, type, full) {
