$(function () {
		     ...
		     "columnDefs": [
				{
					...
					"render" : function(data, type, full) {
						return handle_loanType(data, full, 1);
					}
				},
				{
				...
				},
				{
					...
					"data" : "dealwithStatus", 
					"render" : function(data, type, full) {
						return handle_dealwithStatus(data, full, 1);
					}
				},
				{
				"targets" : [ 10,12,17], // 目标列位置，下标从0开始
					"render" : function(data, type, full) {
   ...
   $('input[type="checkbox"]', tableColumnToggler).change(function () {
	...
	var detailRows = [];
	jQuery('#sample_3 tbody').on( 'click', 'tr td.details-control', function () {
